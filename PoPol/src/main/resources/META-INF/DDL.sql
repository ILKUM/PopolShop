...
COMMENT ON COLUMN REBOARD.ID IS '작성자';
...
CREATE TABLE KRMOVIE (
	...
	KRDATE DATE DEFAULT SYSDATE NOT NULL /* 한국개봉날짜 */
);
...
CREATE TABLE RECOMENT (
	...
	ARSEQ NUMBER NOT NULL, /* 미국영화번호 */
	EUSEQ NUMBER NOT NULL, /* 유럽영화번호 */
	ID VARCHAR2(100) NOT NULL, /* 댓글작성자 */
...
COMMENT ON COLUMN RECOMENT.ID IS '댓글작성자';
...
COMMENT ON TABLE recommend IS '새 테이블';
...
COMMENT ON COLUMN recommend.ID IS '작성자';
