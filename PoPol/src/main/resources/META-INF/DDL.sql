...
CREATE TABLE RECOMENT (
	...
	RTIME DATE DEFAULT SYSDATE NOT NULL, /* 덧글작성시간 */
...
CREATE TABLE FREE (
	...
	FTIME DATE DEFAULT SYSDATE NOT NULL, /* 자유작성시간 */
...
COMMENT ON COLUMN REVIEWMEM.RVSEQ IS '리뷰글시퀀스';
