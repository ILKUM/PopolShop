...
CREATE TABLE MEMBER (
	...
	ISMLIKE NUMBER NOT NULL, /* 추천 수 */
	ISSTOP NUMBER NOT NULL, /* 정지 여부 */
	SCONTENT VARCHAR2(100) /* 정지 사유 */
	);
...
COMMENT ON COLUMN MEMBER.MLIKE IS '추천 수';

COMMENT ON COLUMN MEMBER.ISMLIKE IS '추천여부';

COMMENT ON COLUMN MEMBER.ISSTOP IS '정지여부';

COMMENT ON COLUMN MEMBER.SCONTENT IS '정지 사유 ';
...
CREATE TABLE REBOARD (
	...
	RVNAME VARCHAR2(100) NOT NULL /* 리뷰 영화제목 */
);
...
CREATE TABLE recommend (
	...
	RCNAME VARCHAR2(100) NOT NULL /* 추천 영화제목 */
	);
...
ALTER TABLE RVREPLY
	ADD
		...
		/* 쿠폰등록 */
CREATE TABLE ISCOUPON (
	CPSEQ NUMBER NOT NULL, /* 쿠폰멤버시퀀스 */
	EMAIL VARCHAR2(100) NOT NULL /* 아이디 */
);

COMMENT ON TABLE ISCOUPON IS '쿠폰등록';

COMMENT ON COLUMN ISCOUPON.CPSEQ IS '쿠폰멤버시퀀스';

COMMENT ON COLUMN ISCOUPON.EMAIL IS '아이디';

CREATE UNIQUE INDEX PK_ISCOUPON
	ON ISCOUPON (
		CPSEQ ASC
	);

ALTER TABLE ISCOUPON
	ADD
		CONSTRAINT PK_ISCOUPON
		PRIMARY KEY (
			CPSEQ
		);
...
COMMENT ON TABLE FILEBOARD IS '새 테이블';
