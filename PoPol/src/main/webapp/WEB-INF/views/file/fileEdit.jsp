    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
		...
		<input type="submit" class="form-control editdelete" value="완료" id="editfile" hidden="">
		</div>	
		<hr>
	       <p style="margin-left: 25px;margin-bottom: 16px; "> 파일변경 : <input type="file" name="filesrc" id="Photo"></p>
		<div style="height:520px ;border: 1px solid rgba(0,0,0,0.5);margin-left: 2%;margin-right: 2%;border-radius: 0.5rem;padding: 1% 2% 1% 2%;margin-bottom: 80px;">              
	        <span id="profiles">${file.filename}</span>
	        <div class="fileDetail" style="margin-left: 0px;margin-bottom: 0px;font-size: 17px;">
	       <textarea rows="5" style="width:100%;border: 0; border-bottom: 1px solid #ced4da; padding: 1%; height: 480px;" id="editReviewcontent" name="fcontent">${file.fcontent}</textarea>
	        </div>    
		</div>
		  </form>
            <!-- #/ container -->
