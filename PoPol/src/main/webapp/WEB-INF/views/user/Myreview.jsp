        ...
        ***********************************-->
		...
		<div class="row" style="margin: 2% 2% 15px 2%">
			<div class="col-sm-12" style="padding-left: 0">
				<h3 style="padding-left: 15px;"><spring:message code="myre.main" /></h3>
			</div>
		</div>
		<div class="row" style="margin-left: 2%;">
			<ul class="nav nav-pills">
			    ...
			    <li class="nav-item">
			      <a class="nav-link" href="writeMyReview.do" style="color: #ba90c4;"><spring:message code="review.title" /></a>
			    </li>		
			    <li class="nav-item">
