    ...
    ***********************************-->
	...
	<form onsubmit="return pwdcheck()" action="editCheck.do" method="post" enctype="multipart/form-data">
						...
						<c:otherwise>
                             ...
                             <input type="file" name="filesrc" id="Photo" accept="image/*">
                                    ...
                                    <div class="media-body">
                                        <h3 class="mb-0" style="padding-left: 2%;">${admin.name}</h3>
                                        <p class="text-muted mb-0" style="margin-left: 2%; width: 300px;">${admin.email}</p>
                                    </div>
                                </div>
		</div>
		...
		<div class="form-group" style="width: 100%">
    		...
    		<input class="form-control myinfo" type="text" id="email" name="email" style="width: 60%" readonly="readonly" value="${admin.email}">
    		<br>
    		...
    		<input class="form-control myinfo" type="text" id="name" name="name" style="width: 60%" placeholder="7자까지 입력가능합니다" value="${admin.name}">
