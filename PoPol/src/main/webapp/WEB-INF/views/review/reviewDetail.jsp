    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
		...
		<div class="col-sm-4" style=" padding-left: 250px;">
			...
			<span id="myissueSubject" style="padding-left: 60px;font-size: 20px;">${review.retitle}</span>
			<span style="float:right ;padding-top: 1%;padding-right: 55px;">${fn:substring(review.retime,0,19)}</span>
			</div>
